...
export function AddPatientModal({ open, onClose }: AddPatientModalProps) {
    ...
    return (
        <Modal open={open} onClose={onClose} title={t('modals.addTitle')}>
            <form onSubmit={handleSubmit} className="flex max-h-[70vh] flex-col gap-4 overflow-y-auto pe-1">
                <div className="grid grid-cols-2 gap-3">
                    <div className="flex flex-col gap-1.5">
                        ...
                        <input type="text" value={form.data.first_name} onChange={(e) => form.setData('first_name', e.target.value)} className={inputClass} />
                    ...
                    <div className="flex flex-col gap-1.5">
                        ...
                        <input type="text" value={form.data.last_name} onChange={(e) => form.setData('last_name', e.target.value)} className={inputClass} />
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div className="flex flex-col gap-1.5">
                        ...
                        <input type="date" value={form.data.date_of_birth} onChange={(e) => form.setData('date_of_birth', e.target.value)} className={inputClass} />
                    ...
                    <div className="flex flex-col gap-1.5">
                        ...
                        <select value={form.data.gender} onChange={(e) => form.setData('gender', e.target.value)} className={inputClass}>
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div className="flex flex-col gap-1.5">
                        ...
                        <input type="tel" value={form.data.phone} onChange={(e) => form.setData('phone', e.target.value)} className={inputClass} />
                ...
                <div className="flex flex-col gap-1.5">
                    ...
                    <input type="text" value={form.data.address} onChange={(e) => form.setData('address', e.target.value)} className={inputClass} />
                </div>

                <div className="grid grid-cols-3 gap-3">
                    <div className="flex flex-col gap-1.5">
                        <label className={labelClass}>{t('form.city')}</label>
                        <input type="text" value={form.data.city} onChange={(e) => form.setData('city', e.target.value)} className={inputClass} />
                    </div>
                    <div className="flex flex-col gap-1.5">
                        <label className={labelClass}>{t('form.state')}</label>
                        <input type="text" value={form.data.state} onChange={(e) => form.setData('state', e.target.value)} maxLength={2} className={inputClass} />
                    </div>
                    <div className="flex flex-col gap-1.5">
                        <label className={labelClass}>{t('form.zipCode')}</label>
                        <input type="text" value={form.data.zip_code} onChange={(e) => form.setData('zip_code', e.target.value)} className={inputClass} />
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div className="flex flex-col gap-1.5">
                        ...
                        <select value={form.data.preferred_language} onChange={(e) => form.setData('preferred_language', e.target.value)} className={inputClass}>
